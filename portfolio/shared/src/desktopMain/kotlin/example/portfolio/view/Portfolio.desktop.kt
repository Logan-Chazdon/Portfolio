...
import example.portfolio.utils.getPreferredWindowSize
...
class ExternalNavigationEventBus {
    private val _events = MutableSharedFlow<ExternalPortfolioEvent>(
        replay = 1,
        onBufferOverflow = BufferOverflow.DROP_LATEST
    )
    val events = _events.asSharedFlow()

    fun produceEvent(event: ExternalPortfolioEvent) {
...
@Composable
fun ApplicationScope.PortfolioDesktop() {
